...
demo.BattleState.prototype.end_battle = function () {
    ...
    if (tutorial) {
        this.game.state.start(this.level_data.extraInfo.nextState, true, false, [this.prefabs.Monk.stats.maxHP + this.level_data.extraInfo.HPIncrease, this.prefabs.Monk.stats.maxMP + this.level_data.extraInfo.MPIncrease, this.prefabs.Monk.stats.maxSP + this.level_data.extraInfo.SPIncrease, this.prefabs.Monk.stats.maxHP + this.level_data.extraInfo.HPIncrease, this.prefabs.Monk.stats.maxMP + this.level_data.extraInfo.MPIncrease, this.prefabs.Monk.stats.maxSP + this.level_data.extraInfo.SPIncrease],[5,5,5]);
    }
    else {
